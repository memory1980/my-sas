...
def qper(
    ...
    # result['performanceExpressGRYOY'] = pd.to_numeric(result['performanceExpressGRYOY'], errors='coerce')    
    ...
    result = result[result['performanceExpressGRYOY'] > 0]
    ...
    py_path = os.path.join(data_dir, "qper_data.csv")
...
if __name__ == "__main__":
    ...
    pd=qper(stockcodes=code,offsetday=180)
